...
<html>
    ...
    <body id="ask">
        ...
        <a href="index.php">
            <div id="log">
                <div id="i"></div>><div id="ntro">Grequo</div>
            </div>
        </a>
        <ul id="nav-bar">
            ...
            <div id="sf">
                <center>
                    <div class="heading ask">
                        <h1 class="logo"><div id="i">G</div><div id="cir">i</div><div id="ntro">requo</div></h1>
                    ...
                    <form action="<?php echo htmlspecialchars( $_SERVER["PHP_SELF"] ); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <select name="cat">
                            ...
                            <option value="Algorithms">Battery Electric Vehicles</option>
                            <option value="Architecture">Plugin Hybrid Electric</option>
                            <option value="Theory Of Computation">Hybrid cars</option>
